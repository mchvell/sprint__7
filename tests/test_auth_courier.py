...
class TestCourierAuth:
    ...
    def test_auth_success(self):
        ...
        assert response.status_code == valid_status_code and "id" in response.json()
    ...
    def test_auth_without_one_empty_field(self):
        ...
        assert response.status_code == error_status_code and response.text == auth_data.not_enough_data
